...
const TermsOfService = props => {
  ...
  return (
    <div className={classes}>
      ...
      <p>
      Welcome to Discover sailing Asia Limited
 These terms and conditions outline the rules and regulations for the use of Lemlabs Asia Hong kong Limited's Website. 
      </p>

      <h2>1</h2>
      <p>
      By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Lemlabs Asia Hong kong Limited's website
 ...
 We employ the use of cookies. By using Lemlabs Asia Hong kong Limited's website you consent to the use of cookies
 in accordance with Lemlabs Asia Hong kong Limited's privacy policy.Most of the modern day interactive web sites
 use cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site
 to enable the functionality of this area and ease of use for those people visiting. Some of our
 affiliate / advertising partners may also use cookies.License
 Unless otherwise stated, Lemlabs Asia Hong kong Limited and/or it's licensors own the intellectual property rights for
 all material on Lemlabs Asia Hong kong Limited. All intellectual property rights are reserved. You may view and/or print
 pages from http://www.discoversailingasia.com for your own personal use subject to restrictions set in these terms and conditions.
      </p>

      <h2>2 You must NOT</h2>
      <p>
      Republish material from http://www.discoversailingasia.com
  Sell, rent or sub-license material from http://www.discoversailingasia.com
  Reproduce, duplicate or copy material from http://www.discoversailingasia.com
 
 Redistribute content from Lemlabs Asia Hong kong Limited (unless content is specifically made for redistribution).
Hyperlinking to our Content
 ...
 you must notify us by sending an e-mail to weiyong.chong@discoversailingasia.com.
 ...
 No use of Lemlabs Asia Hong kong Limited's logo or other artwork will be allowed for linking absent a trademark license
 agreement.
Iframes
