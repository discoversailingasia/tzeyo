...
const routeConfiguration = () => {
  return [
    ...
    {
      path: '/thaistatic',
      name: 'CountryThaiPage',
      component: CountryThaiPage,
    },
    {
      path: '/sgstatic',
      name: 'SingaporeStaticPage',
      component: SingaporeStaticPage,
    },
    {
      path: '/phuketstatic',
      name: 'PhuketStaticPage',
      component: PhuketStaticPage,
    },
    {
      path: '/okinawastatic',
      name: 'OkinawaStaticPage',
      component: OkinawaStaticPage,
    },
    {
      path: '/dubrostatic',
      name: 'DubrovnikStaticPage',
      component: DubrovnikStaticPage,
    },
    {
      path: '/dalmastatic',
      name: 'DalmatiaStaticPage',
      component: DalmatiaStaticPage,
    },
    {
      path: '/istriastatic',
      name: 'IstriaStaticPage',
      component: IstriaStaticPage,
    },
    
    {
      path: '/krkstatic',
      name: 'KrkStaticPage',
      component: KrkStaticPage,
    },
    {
      path: '/gallerytest',
      name: 'GridGalleryTestPage',
      component: GridGalleryTestPage,
    },
    {
      path: '/',
      name: 'LandingPage',
